...
class SpecWeave(gl.Contract):
    ...
    def review_release(self, proposal_id: u256) -> str:
        ...
        def leader_fn() -> str:
            # Semantic adjudication via AI consensus.
            # Evidence binding (manifest URL + digest + commit SHA) is validated
            # deterministically before this nondet block by propose_release.
            # gl.nondet.web.get cannot be nested inside gl.eq_principle.prompt_comparative.
